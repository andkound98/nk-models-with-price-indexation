...
nk = "/small_scale_nk_models/nk.yaml" # If needed, adjust for individual file path here
nk_mod = ep.load(nk)
_ = nk_mod.solve_stst() 

# Load and solve NK model with price indexation 
nk_price_indexation = "/small_scale_nk_models/nk_price_indexation.yaml" # If needed, adjust for individual file path here
